...
<form action="addDonar">
	<table border="1" bgcolor="darkred" align="center">
		<tr>
			...
			<td> <input type="text" placeholder="Enter Doner name" name="dname"></td>
		</tr>
		<tr>
			<th><font color="white"> Blood Bank</font> </th>
			<td> <input type="text" placeholder="Enter  Blood Bank name" name="hosp"></td>
		</tr>
		<tr>
